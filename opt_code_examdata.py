...
fit_and_evaluate_model_manual(xtrain_scaled, xtest_scaled, ytrain, y_test=None, dataset_model_scores=dataset_model_scores, log_file=log_file)

print_log("\n=== Running Hyperopt Optimization ===", log_file)
fit_and_evaluate_model_hyperopt(xtrain_scaled, xtest_scaled, ytrain, y_test=None, dataset_model_scores=dataset_model_scores, log_file=log_file)

print_log("\n=== Running GPBO Optimization ===", log_file)
fit_and_evaluate_model_gpbo(xtrain_scaled, xtest_scaled, ytrain, y_test=None, dataset_model_scores=dataset_model_scores, log_file=log_file)


print_log("\n=== Running Random Search Tuning ===", log_file)
fit_and_evaluate_model_tuned(xtrain_scaled, xtest_scaled, ytrain, y_test=None, optimization="random", dataset_model_scores=dataset_model_scores, log_file=log_file)

print_log("\n=== Running Bayesian Tuning (Optuna) ===", log_file)
fit_and_evaluate_model_tuned(xtrain_scaled, xtest_scaled, ytrain, y_test=None, optimization="bayesian", dataset_model_scores=dataset_model_scores, log_file=log_file)
